...
// 		inline distance(int u, int v) const{
// 		
// 			return D[u][v];
// 		}
...
// 		void imprime( ){
// 			for( int x=0; x<15 && x<numberOfVertices();x++){
// 				cout << SortedVertices[x] << "  ->  " << BtCt(SortedVertices[x]) << endl;
// 				
// 			}
// 			cout << "El numero de aristas es:   " << numberOfEdges() << endl;
// 		}
// 		
